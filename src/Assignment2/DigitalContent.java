...
public abstract class DigitalContent implements Comparable<DigitalContent> {
    ...
    public void setCurrentlyStreamed(boolean currentlyStreamed) {
    ...
    public boolean match(String query) {
        return title.toLowerCase().contains(query.toLowerCase()) || publisher.toLowerCase().contains(query.toLowerCase()) || released.toLowerCase().contains(query.toLowerCase());
    }
